...
OUTPUT_VIDEO_PATH = os.path.join(OUTPUT_DIR, 'output_result_final.mp4')
EVENT_LOG_PATH = os.path.join(OUTPUT_DIR, 'event_record.txt') # 📝 事件紀錄檔輸出路徑
